...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //$consulta = "SELECT * FROM licencias_fcia where (aux7 not like 'TANGO') and (fecha_carga_lic LIKE '$hoy%') and aux5 NOT LIKE ''";
    //$consulta = "SELECT * FROM licencias_fcia where (aux7 not like 'TANGO') and (fecha_carga_lic LIKE '2024-10-13%')";
...
///////////////////////////////////////////////////////////////////////////////// TEST SI FUNCA 
            if (trim($unidad_cantidadx) == '$') { // insertar PESOS
                ...
                echo "ESTA FECHA VA A TANGO: $fecha_final<br>";
