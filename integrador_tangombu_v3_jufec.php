...
// VERSION 3.0 PARA INSERTAR A TANGO DESDE licencias_jufec GALACTUS
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //$consulta = "SELECT * FROM licencias_jufec where (aux3 like 'NOFAR_SRL') and (aux5 like 'APER')";
    //$consulta = "SELECT * FROM licencias_jufec where aid_licencia like '242'";
    $hoy = date("Y-m-d");    
    $consulta = "SELECT * FROM licencias_jufec where (aux7 not like 'TANGO') and (fecha_carga_lic LIKE '$hoy%')";
    //$consulta = "SELECT * FROM licencias_jufec where (aux7 not like 'TANGO')";

    //$consulta = "SELECT * FROM licencias_jufec where (aux7 not like 'TANGO') and (fecha_carga_lic LIKE '$hoy%') and aux5 NOT LIKE ''";
    //$consulta = "SELECT * FROM licencias_jufec where (aux7 not like 'TANGO') and (fecha_carga_lic LIKE '2024-10-13%')";
    ...
    if($row_cnt==0){
        echo "<b>NO HAY DATOS EN LA CONSULTA DE licencias_jufec </b><br>";
        exit;
...
///////////////////////////////////////////////////////////////////////////////// TEST SI FUNCA 
            if (trim($unidad_cantidadx) == '$') { // insertar PESOS
                ...
                if( $stmt === false ) {
                    ...
                    $consulta_update = "UPDATE licencias_jufec SET estado = 'E' WHERE aid_licencia = '$aid_licencia'";
                    $resultado_update = mysqli_query($enlace_galactus, $consulta_update);
                    ...
                    $consulta_update = "UPDATE licencias_jufec SET aux7 = 'TANGO' WHERE aid_licencia = '$aid_licencia'";
                    $resultado_update = mysqli_query($enlace_galactus, $consulta_update);                    
                }
