...
//$dbname = array("JEMAN_SRL","FACOR_SRL_2017"); 
...
if (! $conn2) {
    ...
    $file_legajos = fopen("/var/www/html/file_legajos.csv", "w");
              ...
              for ($x = 0; $x < $cantidad; $x++) {
                ...
                $basecita=$dbname[$x].'.dbo.AXV_LEGAJO'; // tablita con los datos del legajo
...
//where NRO_DOCUMENTO = 34655043";
                ...
                while( $row3 = sqlsrv_fetch_array( $msresult_emp, SQLSRV_FETCH_ASSOC) ) {
                        ...
                        $query_ins = "INSERT INTO legajos_bk (`legajo_idx`, `nro_legajo`, `id_legajo`, `id_departamento`, `cod_departamento`, `cod_empresa`, `apellido`,
                        ...
                        VALUES ('$legajo_idx','$NRO_LEGAJO','$ID_LEGAJO','$ID_DEPARTAMENTO','$COD_DEPARTAMENTO','$dbname[$x]','$APELLIDO','$NOMBRE','$DESC_DOCUMENTO','$NRO_DOCUMENTO','$FECHA_NACIMIENTO',
